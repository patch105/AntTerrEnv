...
#files <- list.files("Z:/AntarcticFutureHabitat/Data/PolarRes/MAR_CESM2_tif")
files <- list.files("/mnt/hpccs01/home/n11222026/AntarcticFutureHabitat/Data/PolarRes/MAR_CESM2_tif")

#file_paths <- list.files("Z:/AntarcticFutureHabitat/Data/PolarRes/MAR_CESM2_tif",
#full.names = TRUE, recursive = TRUE)
file_paths <- list.files("/mnt/hpccs01/home/n11222026/AntarcticFutureHabitat/Data/PolarRes/MAR_CESM2_tif",
                         full.names = TRUE, recursive = TRUE)

# Set the output directory
# outpath <- "Z:/AntarcticFutureHabitat/Data/Environmental_predictors/PolarRes/MAR_CESM2"
outpath <- here("Data/Environmental_predictors/PolarRes/MAR_CESM2")
