...
Ant_extent_grid_1km <- rast(Ant_extent, res = 1000, vals = 1)
...
coast_domain <- mask(Ant_extent_grid_10km, coast, updatevalue = NA, touches = T)
...
ice_free_domain <- mask(Ant_extent_grid_10km, ice_free, updatevalue = NA, touches = T)
