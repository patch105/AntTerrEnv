...
#PBS -N Run_PolarRes26_Diagnostics
#PBS -l select=1:ncpus=4:mem=250GB:cpu_id=any
...
load_modules(){
        #module load mamba
		conda activate RLibs_V4.4.1D_new2
...
run_program(){
    cd $PBS_O_WORKDIR
	Rscript PolarRes26_Diagnostics.R $PBS_ARRAY_INDEX
