...
# MAR MPI-ESM1
u <- "http://ftp.climato.be/fettweis/MARv3.13/PolarRES/Antarctic/MAR-MPI-ESM1/"
model_name <- "MAR_MPI_ESM1_"
...
# 
# system("gdalinfo /vsicurl/http://ftp.climato.be/fettweis/MARv3.13/PolarRES/Antarctic/MAR-MPI-ESM1/MARv3.13-ANT-MPI-1985.nc?sd_name=PRH&a_srs=+proj=stere +lat_0=-90 +lat_ts=-90 +lon_0=20&a_ullr=-4206600,3693600,3462750,-3129300")
