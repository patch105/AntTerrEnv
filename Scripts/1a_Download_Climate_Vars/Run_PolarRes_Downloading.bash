...
#PBS -N Run_PolarRes_DownloadHCLIM
#PBS -l select=1:ncpus=8:mem=50GB:cpu_id=any
#PBS -l walltime=24:00:00
#PBS -o PolarRes_download.out 
#PBS -e PolarRes_download.err
...
run_program(){
    cd $PBS_O_WORKDIR
	Rscript PolarRes_Downloading_HCLIM_MPI_ESM.R 
